...
pub fn main(process_init: std.process.Init) !void {
    ...
    const render_start = skim_io.nanoTimestamp();
    ...
    const content_time = skim_io.nanoTimestamp();
    ...
    const highlight_time = skim_io.nanoTimestamp();
    ...
    const render_time = skim_io.nanoTimestamp();
